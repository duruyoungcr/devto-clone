...
const navLinks = [
    ...
    },
    {
        title: 'About',
        href: '/about',
        icon: <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" className="rainbow-logo" preserveAspectRatio="xMinYMin meet" width="24" height="24">
